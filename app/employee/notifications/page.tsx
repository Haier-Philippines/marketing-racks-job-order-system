      ...
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <div className="card overflow-hidden divide-y divide-slate-50">
          {loading ? (
            ...
            <div className="py-16 flex flex-col items-center gap-3 text-center">
              ...
              <p className="text-sm text-slate-400">You&apos;ll be notified about your request updates here.</p>
            </div>
          ) : notifs.map(notif => {
            ...
            return (
              <div key={notif.id}
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  {notif.refId && (
                    <Link href={`/employee/my-requests/${notif.refId}`}
        ...
        {notifs.length > 0 && (
          <div className="text-center">
            <p className="text-xs text-slate-400">Showing last {notifs.length} notifications</p>
          </div>
        )}
      </div>
    </EmployeeLayout>
